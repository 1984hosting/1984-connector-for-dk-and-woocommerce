...
class WooCooCustomerService {
   ...
   * @return array
   */
  public function getTransactionsForCustomer(string $id) {
   ...
   * @return void
   */
  public function getCustomerCardInformation(string $id) {
   ...
   * @return void
   */
  public function updateCustomerCardInformation(string $id, string $data) {
   ...
   * @return void
   */
  public function getQuotesForCustomer(string $id) {
   ...
   * @return void
   */
  public function getProjectsForCustomer(string $id) {
   ...
   * @return void
   */
  public function getCustomerBasedOnFilter() {
   ...
   * @return void
   */
  public function getCountOfCustomersThatHaveChangedByConditions() {
   ...
   * @return void
   */
  public function generatePhoneCallerIDByPhoneNumber() {
   ...
   * @return void
   */
  public function getDocumentAssignedToCustomer(string $customer_number, int $document_id) {
   ...
   * @param ItemReciverModel $receiver
   * @return void
   * @throws WooCooServiceException
   */
   ...
   * @return void
   */
  public function getGeneralLedgerTransaction() {
  ...
  private function handleDkResponse($response, $message): array|stdClass|null
  {
    ...
    {
      throw new WooCooServiceException('Data not found',
        $response['response_code']);
    }
    return null;
  }
