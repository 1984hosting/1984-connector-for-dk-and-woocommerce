...
class WooCooSalesInvoiceService  {
  ...
  public function calculatePricesBasedOnProductCustomerAndDiscountGroups() {
    // @TODO: Implement this calculatePricesBasedOnProductCustomerAndDiscountGroups() function.
  }

  public function getDefinedPriceRules()
  {
    // @TODO: Implement this getDefinedPriceRules() function.
  }

  public function createCreditInvoiceBasedOnAnotherInvoice()
  {
   ...
   * @throws WooCooServiceException
   */
  public function getSaleInvoices(int    $page, int $count, string $sorttype = 'Ascending', bool $includeLines = null,
                                  string $createdAfter = null, string $createdBefore = null, string $modifiedAfter = null,
                                  string $modifiedBefore = null, string $dueAfter = null, string $salesPerson = null,
                                  string $reference = null, int $recordid = null, string $customer = null,
                                  string $project = null, string $itemcode = null, string $include = null,
                                  string $exclude = null, string $sort = null) : array|null
  {
    $data_from_dk = $this->handleDkResponse(
      $this->apiService->getSaleInvoices($page, $count, $sorttype, $includeLines, $createdAfter, $createdBefore,
                                         $modifiedAfter, $modifiedBefore, $dueAfter, $salesPerson, $reference,
                                         $recordid, $customer, $project, $itemcode, $include, $exclude, $sort),
  ...
  public function refreshInvoiceInDKPlusFromDK()
  {
    // @TODO: Implement this refreshInvoiceInDKPlusFromDK() function.
  }

  public function createPaymentPlanForInvoice()
  {
    // @TODO: Implement this createPaymentPlanForInvoice() function.
  }

  public function cancelPaymentPlanForInvoice()
  {
  ...
  public function createSaleInvoicesInBulk(array $orders)
  {
